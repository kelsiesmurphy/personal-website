...
function EarthMaterial({ sunDirection = defaultSunDirection }) {
  // Load textures using useLoader directly in the component
  const map = useLoader(THREE.TextureLoader, "./textures/8k_earth_daymap.jpg");
  const nightMap = useLoader(THREE.TextureLoader, "./textures/8k_earth_nightmap.jpg");
  const cloudsMap = useLoader(THREE.TextureLoader, "./textures/8k_earth_clouds.jpg");

  // Use React.useMemo to create the ShaderMaterial only once
